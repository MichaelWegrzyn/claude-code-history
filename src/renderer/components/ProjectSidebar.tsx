          ...
          <div className="flex items-center gap-3">
            ...
            <div className="w-8 h-8 rounded-lg bg-accent flex items-center justify-center">
              <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                <path d="M4 6h12c1.1 0 2 .9 2 2v3c0 1.1-.9 2-2 2H8l-2 2v-2H4c-1.1 0-2-.9-2-2V8c0-1.1.9-2 2-2z"/>
                <path d="M20 12v4c0 1.1-.9 2-2 2h-2v2l-2-2H8c-1.1 0-2-.9-2-2v-1h10c1.1 0 2-.9 2-2v-1h2z" opacity="0.7"/>
                <circle cx="19" cy="8" r="1" fill="currentColor"/>
                <circle cx="21" cy="6" r="0.5" fill="currentColor" opacity="0.8"/>
              </svg>
            </div>
